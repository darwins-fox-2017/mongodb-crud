...
router.get('/api/book', bookController.readBooks)
router.post('/api/book/:id', bookController.createBook)
...
router.get('/api/customer', customerController.readCustomers)
router.post('/api/customer/:id', customerController.createCustomer)
...
router.get('/api/transaction', transactionController.readTransactions)
router.post('/api/transaction/:id', transactionController.createTransaction)
